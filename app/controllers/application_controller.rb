class ApplicationController < ActionController::Base
  ...
  protected
	 ...
	 def configure_permitted_parameters
	   ...
	   devise_parameter_sanitizer.permit(:account_update) { |u| u.permit(:name, :email, :password, :current_password, :password_confirmation, :photo, :miniresume, :linkedin, :twitter, :facebook, :username, :website, :whatido, :achievements, :lookingfor, :investor) }
	 end
end
